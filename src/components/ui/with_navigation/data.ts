...
export const navigationData: Setting[] = [
  {id: MENU_ID_HOME, label: lang('0008'), icon: 'HomeOutlined', activeIcon: 'Home', path: '/', children: []},//ホーム
  {
    id: MENU_ID_DEVELOPMENT,
    label: lang('0009'),
    icon: 'CodeOutlined',
    activeIcon: 'Code',
    path: '/development',
  ...
  {
    id: MENU_ID_WORK, label: lang('0013'), icon: 'WorkOutlined', activeIcon: 'Work', path: '/work', children: [//一般業務
